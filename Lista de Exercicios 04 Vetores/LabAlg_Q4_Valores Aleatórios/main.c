...
int main(int argc, char *argv[]) {
	...
	do{
		...
		if (opc == 1){
			...
			printf("\nA soma dos números aleatórios é: %i \n", somar);
			printf("\n\n");
			...
			printf("\nA soma dos números aleatórios ímpares é: %i\n", somar);
			printf("\nO total de números aleatórios ímpares é: %i\n", contar);
			printf("\n\n");
			
		}else if (opc == 6){
			
			printf("\nDigite um número para saber quantos números são maiores que ele: \n");
			scanf("%i", &maior);
			...
			for (i = 0; i < 60; i++){
				...
				if(vetorNumeros[i] > maior){
					...
					printf("Números maiores que %i [%i]: %i \n", maior, i, vetorNumeros[i]);
			...
			printf("\nDigite um número para saber quantos números são iguais a ele: \n");
			scanf("%i", &igual);
			...
			printf("\nO total de números iguais a %i é: %i\n", igual, contar);
			printf("\n\n");
